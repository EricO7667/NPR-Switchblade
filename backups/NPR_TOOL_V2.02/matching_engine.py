...
ENG_RETURN_K = 10               # final candidates shown
...
class MatchingEngine:
    ...
    #We need to remake this ;pg. fall back should not be the dense embedder, alothough this is okay for now for checking the funcinlaity of how well sparse embedding works. The dense embedded should be used for ctegorical matches,t eh sparse embedded used secondary, reranker used thirdly
    def _engineering_match(self, npr: NPRPart) -> Optional[MatchResult]:
        ...
        return MatchResult(
            ...
            confidence=round(clamp01(best_score), 3),
            inventory_part=best,
